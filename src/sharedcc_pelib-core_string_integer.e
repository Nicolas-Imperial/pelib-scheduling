...
# 1 "<command-line>" 2
# 1 "string_integer.c"
# 1 "../include/pelib/string_integer.h" 1
...
# 2 "../include/pelib/string_integer.h" 2
...
# 3 "../include/pelib/string_integer.h" 2
...
# 1 "../include/pelib/pair.h" 1
# 36 "../include/pelib/pair.h"
struct pelib_pair_string_int
{
 string key;
 int value;
};
typedef struct pelib_pair_string_int pelib_pair_string_int_t;
...
# 26 "../include/pelib/structure.h" 2
# 59 "../include/pelib/structure.h"
pelib_pair_string_int_t *
pelib_pelib_pair_string_int_t_alloc_struct();
...
int
pelib_pelib_pair_string_int_t_alloc_buffer(pelib_pair_string_int_t* obj, size_t n);
...
int
pelib_pelib_pair_string_int_t_set_buffer(pelib_pair_string_int_t* obj, void* buffer, size_t n);



pelib_pair_string_int_t *
pelib_pelib_pair_string_int_t_alloc();
...
pelib_pair_string_int_t *
pelib_pelib_pair_string_int_t_alloc_collection(size_t n);
...
pelib_pair_string_int_t *
pelib_pelib_pair_string_int_t_alloc_from(void* buffer, size_t n);
...
int
pelib_pelib_pair_string_int_t_init(pelib_pair_string_int_t *obj);
...
int
pelib_pelib_pair_string_int_t_copy(pelib_pair_string_int_t src, pelib_pair_string_int_t* dst);
...
int
pelib_pelib_pair_string_int_t_free_struct(pelib_pair_string_int_t *obj);
...
int
pelib_pelib_pair_string_int_t_free_buffer(pelib_pair_string_int_t *);




int
pelib_pelib_pair_string_int_t_free(pelib_pair_string_int_t *);




int
pelib_pelib_pair_string_int_t_destroy(pelib_pair_string_int_t);




int
pelib_pelib_pair_string_int_t_compare(pelib_pair_string_int_t a, pelib_pair_string_int_t b);
...
FILE*
pelib_pelib_pair_string_int_t_printf(FILE* str, pelib_pair_string_int_t obj);
...
FILE*
pelib_pelib_pair_string_int_t_printf_detail(FILE* str, pelib_pair_string_int_t obj, int lvl);
...
size_t
pelib_pelib_pair_string_int_t_fwrite(pelib_pair_string_int_t obj, FILE* str);
...
size_t
pelib_pelib_pair_string_int_t_fread(pelib_pair_string_int_t* obj, FILE* str);


char*
pelib_pelib_pair_string_int_t_string(pelib_pair_string_int_t);
...
char*
pelib_pelib_pair_string_int_t_string_detail(pelib_pair_string_int_t, int);
# 45 "../include/pelib/pair.h" 2
# 10 "../include/pelib/string_integer.h" 2



# 1 "../include/pelib/iterator.h" 1
# 40 "../include/pelib/iterator.h"
struct pelib_iterator_pelib_pair_string_int_t
{
 struct pelib_iterator_pelib_pair_string_int_t *previous, *next;
 pelib_pair_string_int_t value;
};
typedef struct pelib_iterator_pelib_pair_string_int_t pelib_iterator_pelib_pair_string_int_t_t;

pelib_iterator_pelib_pair_string_int_t_t*
pelib_pelib_iterator_pelib_pair_string_int_t_next(pelib_iterator_pelib_pair_string_int_t_t*);

pelib_pair_string_int_t
pelib_pelib_iterator_pelib_pair_string_int_t_read(pelib_iterator_pelib_pair_string_int_t_t*);

size_t
pelib_pelib_iterator_pelib_pair_string_int_t_distance(pelib_iterator_pelib_pair_string_int_t_t *start, pelib_iterator_pelib_pair_string_int_t_t *stop);
...
# 59 "../include/pelib/structure.h"
pelib_iterator_pelib_pair_string_int_t_t *
pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc_struct();
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc_buffer(pelib_iterator_pelib_pair_string_int_t_t* obj, size_t n);
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_set_buffer(pelib_iterator_pelib_pair_string_int_t_t* obj, void* buffer, size_t n);



pelib_iterator_pelib_pair_string_int_t_t *
pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc();
...
pelib_iterator_pelib_pair_string_int_t_t *
pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc_collection(size_t n);
...
pelib_iterator_pelib_pair_string_int_t_t *
pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc_from(void* buffer, size_t n);
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_init(pelib_iterator_pelib_pair_string_int_t_t *obj);
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_copy(pelib_iterator_pelib_pair_string_int_t_t src, pelib_iterator_pelib_pair_string_int_t_t* dst);
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_free_struct(pelib_iterator_pelib_pair_string_int_t_t *obj);
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_free_buffer(pelib_iterator_pelib_pair_string_int_t_t *);




int
pelib_pelib_iterator_pelib_pair_string_int_t_t_free(pelib_iterator_pelib_pair_string_int_t_t *);




int
pelib_pelib_iterator_pelib_pair_string_int_t_t_destroy(pelib_iterator_pelib_pair_string_int_t_t);




int
pelib_pelib_iterator_pelib_pair_string_int_t_t_compare(pelib_iterator_pelib_pair_string_int_t_t a, pelib_iterator_pelib_pair_string_int_t_t b);
...
FILE*
pelib_pelib_iterator_pelib_pair_string_int_t_t_printf(FILE* str, pelib_iterator_pelib_pair_string_int_t_t obj);
...
FILE*
pelib_pelib_iterator_pelib_pair_string_int_t_t_printf_detail(FILE* str, pelib_iterator_pelib_pair_string_int_t_t obj, int lvl);
...
size_t
pelib_pelib_iterator_pelib_pair_string_int_t_t_fwrite(pelib_iterator_pelib_pair_string_int_t_t obj, FILE* str);
...
size_t
pelib_pelib_iterator_pelib_pair_string_int_t_t_fread(pelib_iterator_pelib_pair_string_int_t_t* obj, FILE* str);


char*
pelib_pelib_iterator_pelib_pair_string_int_t_t_string(pelib_iterator_pelib_pair_string_int_t_t);
...
char*
pelib_pelib_iterator_pelib_pair_string_int_t_t_string_detail(pelib_iterator_pelib_pair_string_int_t_t, int);
# 58 "../include/pelib/iterator.h" 2
# 14 "../include/pelib/string_integer.h" 2
...
{
 pelib_iterator_pelib_pair_string_int_t_t *first, *last, *middle;
};
typedef struct map_string_int map_string_int_t;
typedef struct pelib_iterator_pelib_pair_string_int_t map_pelib_iterator_pelib_pair_string_int_t_t;
...
# 59 "../include/pelib/structure.h"
map_string_int_t *
pelib_map_string_int_t_alloc_struct();
...
int
pelib_map_string_int_t_alloc_buffer(map_string_int_t* obj, size_t n);
...
int
pelib_map_string_int_t_set_buffer(map_string_int_t* obj, void* buffer, size_t n);



map_string_int_t *
pelib_map_string_int_t_alloc();
...
map_string_int_t *
pelib_map_string_int_t_alloc_collection(size_t n);
...
map_string_int_t *
pelib_map_string_int_t_alloc_from(void* buffer, size_t n);
...
int
pelib_map_string_int_t_init(map_string_int_t *obj);
...
int
pelib_map_string_int_t_copy(map_string_int_t src, map_string_int_t* dst);
...
int
pelib_map_string_int_t_free_struct(map_string_int_t *obj);
...
int
pelib_map_string_int_t_free_buffer(map_string_int_t *);




int
pelib_map_string_int_t_free(map_string_int_t *);




int
pelib_map_string_int_t_destroy(map_string_int_t);




int
pelib_map_string_int_t_compare(map_string_int_t a, map_string_int_t b);
...
FILE*
pelib_map_string_int_t_printf(FILE* str, map_string_int_t obj);
...
FILE*
pelib_map_string_int_t_printf_detail(FILE* str, map_string_int_t obj, int lvl);
...
size_t
pelib_map_string_int_t_fwrite(map_string_int_t obj, FILE* str);
...
size_t
pelib_map_string_int_t_fread(map_string_int_t* obj, FILE* str);


char*
pelib_map_string_int_t_string(map_string_int_t);
...
char*
pelib_map_string_int_t_string_detail(map_string_int_t, int);
# 67 "../include/pelib/map.h" 2


pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_begin(map_string_int_t*);


pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_end(map_string_int_t*);


int
pelib_map_string_int_insert(map_string_int_t*, pelib_pair_string_int_t);


pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_find(map_string_int_t*, string);




int
pelib_map_string_int_compare(map_string_int_t* a1, map_string_int_t* a2);

pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_next(pelib_iterator_pelib_pair_string_int_t_t*);

pelib_pair_string_int_t
pelib_map_string_int_read(pelib_iterator_pelib_pair_string_int_t_t*);

size_t
pelib_map_string_int_size(map_string_int_t*);
# 19 "../include/pelib/string_integer.h" 2
# 2 "string_integer.c" 2




# 1 "../include/pelib/pair.c" 1
# 25 "../include/pelib/pair.c"
...
# 33 "../include/pelib/pair.c"
pelib_pair_string_int_t*
pelib_pelib_pair_string_int_t_alloc_struct()
{
 pelib_pair_string_int_t* pelib_pair;

 pelib_pair = malloc(sizeof(pelib_pair_string_int_t));
...
int
pelib_pelib_pair_string_int_t_init(pelib_pair_string_int_t* pelib_pair)
{
 int a = pelib_string_init(&pelib_pair->key);
...
pelib_pelib_pair_string_int_t_copy(pelib_pair_string_int_t src, pelib_pair_string_int_t* dst)
{
 int a = pelib_string_copy(src.key, &dst->key);
...
char*
pelib_pelib_pair_string_int_t_string(pelib_pair_string_int_t pelib_pair)
{
 char *key = pelib_string_string(pelib_pair.key);
...
char*
pelib_pelib_pair_string_int_t_string_detail(pelib_pair_string_int_t pelib_pair, int level)
{
 if(level == 0)
 {
  return pelib_pelib_pair_string_int_t_string(pelib_pair);
 }
 else
 {
  char *key = pelib_string_string(pelib_pair.key);
...
FILE*
pelib_pelib_pair_string_int_t_printf(FILE* stream, pelib_pair_string_int_t pelib_pair)
{
 char * str;
 str = pelib_pelib_pair_string_int_t_string(pelib_pair);
...
FILE*
pelib_pelib_pair_string_int_t_printf_detail(FILE* stream, pelib_pair_string_int_t pelib_pair, int level)
{
 char * str;
 str = pelib_pelib_pair_string_int_t_string_detail(pelib_pair, level);
...
int
pelib_pelib_pair_string_int_t_free(pelib_pair_string_int_t* pelib_pair)
{
 return pelib_pelib_pair_string_int_t_free_struct(pelib_pair);
}

int
pelib_pelib_pair_string_int_t_free_struct(pelib_pair_string_int_t* pelib_pair)
{
 pelib_string_destroy(pelib_pair->key);
...
int
pelib_pelib_pair_string_int_t_compare(pelib_pair_string_int_t a1, pelib_pair_string_int_t a2)
{
 int a = pelib_string_compare(a1.key, a2.key);
 int b = pelib_int_compare(a1.value, a2.value);
 return a == 0 ? b : a;
}

int
pelib_pelib_pair_string_int_t_destroy(pelib_pair_string_int_t set)
{
 pelib_string_destroy(set.key);
 pelib_int_destroy(set.value);
 return 1;
}
# 7 "string_integer.c" 2
...
pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc_struct()
{
 pelib_iterator_pelib_pair_string_int_t_t* pelib_iterator;

 pelib_iterator = malloc(sizeof(pelib_iterator_pelib_pair_string_int_t_t));
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_init(pelib_iterator_pelib_pair_string_int_t_t* pelib_iterator)
{
...
# 59 "../include/pelib/iterator.c"
                           ;
 return pelib_pelib_pair_string_int_t_init(&pelib_iterator->value);
}
 ...
 *dst = src;
 return pelib_pelib_pair_string_int_t_copy(src.value, &dst->value);
}



char*
pelib_pelib_iterator_pelib_pair_string_int_t_t_string(pelib_iterator_pelib_pair_string_int_t_t pelib_iterator)
{
 char *value = pelib_pelib_pair_string_int_t_string(pelib_iterator.value);
...
char*
pelib_pelib_iterator_pelib_pair_string_int_t_t_string_detail(pelib_iterator_pelib_pair_string_int_t_t pelib_iterator, int level)
{
 if(level == 0)
 {
  return pelib_pelib_iterator_pelib_pair_string_int_t_t_string(pelib_iterator);
 }
 else
 {
  char *value = pelib_pelib_pair_string_int_t_string_detail(pelib_iterator.value, level);
  char *elem = malloc((strlen(value) + 3) * sizeof(char*));
  strcpy(&elem[1], value);
  elem[0] = '{';
  elem[strlen(value)] = '}';
...
FILE*
pelib_pelib_iterator_pelib_pair_string_int_t_t_printf(FILE* stream, pelib_iterator_pelib_pair_string_int_t_t pelib_iterator)
{
 char * str;
 str = pelib_pelib_iterator_pelib_pair_string_int_t_t_string(pelib_iterator);
...
FILE*
pelib_pelib_iterator_pelib_pair_string_int_t_t_printf_detail(FILE* stream, pelib_iterator_pelib_pair_string_int_t_t pelib_iterator, int level)
{
 char * str;
 str = pelib_pelib_iterator_pelib_pair_string_int_t_t_string_detail(pelib_iterator, level);
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_destroy(pelib_iterator_pelib_pair_string_int_t_t pelib_iterator)
{
 pelib_pelib_pair_string_int_t_destroy(pelib_iterator.value);
 return 1;
}

int
pelib_pelib_iterator_pelib_pair_string_int_t_t_free(pelib_iterator_pelib_pair_string_int_t_t* pelib_iterator)
{
 return pelib_pelib_iterator_pelib_pair_string_int_t_t_free_struct(pelib_iterator);
}

int
pelib_pelib_iterator_pelib_pair_string_int_t_t_free_struct(pelib_iterator_pelib_pair_string_int_t_t* pelib_iterator)
{
 free(pelib_iterator);
 return 0;
}
...
int
pelib_pelib_iterator_pelib_pair_string_int_t_t_compare(pelib_iterator_pelib_pair_string_int_t_t a1, pelib_iterator_pelib_pair_string_int_t_t a2)
{
 return pelib_pelib_pair_string_int_t_compare(a1.value, a2.value);
}

pelib_iterator_pelib_pair_string_int_t_t*
pelib_pelib_iterator_pelib_pair_string_int_t_next(pelib_iterator_pelib_pair_string_int_t_t *el)
{
 if(el != 
...
pelib_pair_string_int_t
pelib_pelib_iterator_pelib_pair_string_int_t_read(pelib_iterator_pelib_pair_string_int_t_t *el)
{
 return el->value;
}
...
pelib_pelib_iterator_pelib_pair_string_int_t_distance(pelib_iterator_pelib_pair_string_int_t_t *start, pelib_iterator_pelib_pair_string_int_t_t *stop)
{
 ...
 pelib_iterator_pelib_pair_string_int_t_t *i = start;

 while(pelib_pelib_iterator_pelib_pair_string_int_t_t_compare(*i, *stop) != 0)
 {
  i = pelib_pelib_iterator_pelib_pair_string_int_t_next(start);
  distance++;
 }

 return distance;
}
# 10 "string_integer.c" 2
...
pelib_map_string_int_t_alloc_struct()
{
 map_string_int_t* map;

 map = malloc(sizeof(map_string_int_t));
...
int
pelib_map_string_int_t_init(map_string_int_t* map)
{
 map->first = 
...
static
int
pelib_map_string_int_insert_element(map_string_int_t *map, pelib_iterator_pelib_pair_string_int_t_t *elem)
{
 pelib_iterator_pelib_pair_string_int_t_t *current = map->first, *previous = 
...
# 107 "../include/pelib/map.c"
                       && pelib_string_compare(elem->value.key, current->value.key) > 0)
  {
   previous = current;
  ...
  if(current != 0 && pelib_string_compare(elem->value.key, current->value.key) == 0)
  {
   return 0;
  }
...
int
pelib_map_string_int_insert(map_string_int_t* map, pelib_pair_string_int_t value)
{
 pelib_iterator_pelib_pair_string_int_t_t *new = pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc();
 pelib_pelib_iterator_pelib_pair_string_int_t_t_init(new);
 pelib_pelib_pair_string_int_t_copy(value, &new->value);
 if(!pelib_map_string_int_insert_element(map, new))
 {
  pelib_pelib_iterator_pelib_pair_string_int_t_t_free(new);
  return 0;
 }
 else
 {
...
pelib_map_string_int_t_copy(map_string_int_t src, map_string_int_t* dst)
{
 ...
 pelib_iterator_pelib_pair_string_int_t_t *elem = src.last;
 while(elem != 
...
# 177 "../include/pelib/map.c"
 ...
 {
  pelib_iterator_pelib_pair_string_int_t_t *cpy = pelib_pelib_iterator_pelib_pair_string_int_t_t_alloc();
  pelib_pelib_pair_string_int_t_copy(elem->value, &cpy->value);
  pelib_map_string_int_insert_element(dst, cpy);
  elem = elem->previous;
 }
...
char*
pelib_map_string_int_t_string(map_string_int_t map)
{
 char *str, *grow, *elem;
 size_t i;
 ...
 pelib_iterator_pelib_pair_string_int_t_t *el = map.first;
 while(el != 
...
# 199 "../include/pelib/map.c"
 ...
 {
  elem = pelib_pelib_pair_string_int_t_string(el->value);
...
char*
pelib_map_string_int_t_string_detail(map_string_int_t map, int level)
{
 if(level == 0)
 {
  return pelib_map_string_int_t_string(map);
 }
 else
 {
...
# 251 "../include/pelib/map.c"
  ...
  {
   elem = pelib_pelib_pair_string_int_t_string_detail(el->value, level);
   grow = malloc((strlen(str) + 1) * sizeof(char));
   sprintf(grow, "%s", str);
...
FILE*
pelib_map_string_int_t_printf(FILE* stream, map_string_int_t map)
{
 char * str;
 str = pelib_map_string_int_t_string(map);
...
FILE*
pelib_map_string_int_t_printf_detail(FILE* stream, map_string_int_t map, int level)
{
 char * str;
 str = pelib_map_string_int_t_string_detail(map, level);
...
int
pelib_map_string_int_t_destroy(map_string_int_t map)
{
 pelib_iterator_pelib_pair_string_int_t_t *elem = map.first;
 while(elem != 
...
# 313 "../include/pelib/map.c"
 ...
 {
  pelib_iterator_pelib_pair_string_int_t_t *current = elem;
  elem = elem->next;
  pelib_pelib_iterator_pelib_pair_string_int_t_t_destroy(*current);
 }
 return 1;
}

int
pelib_map_string_int_t_free_buffer(map_string_int_t* map)
{
 pelib_iterator_pelib_pair_string_int_t_t *elem = map->first;
 while(elem != 
...
# 326 "../include/pelib/map.c"
                  )
 {
  pelib_iterator_pelib_pair_string_int_t_t *current = elem;
  elem = elem->next;
  pelib_pelib_iterator_pelib_pair_string_int_t_t_free(current);
 }
 return 1;
}

int
pelib_map_string_int_t_free_struct(map_string_int_t* map)
{
 free(map);
 return 1;
}
...
int
pelib_map_string_int_t_free(map_string_int_t* map)
{
 pelib_map_string_int_t_free_buffer(map);
 pelib_map_string_int_t_free_struct(map);
 return 1;
}

int
pelib_map_string_int_t_compare(map_string_int_t a1, map_string_int_t a2)
{
 pelib_iterator_pelib_pair_string_int_t_t *e1 = a1.first;
 pelib_iterator_pelib_pair_string_int_t_t *e2 = a2.first;
...
# 356 "../include/pelib/map.c" 3 4
                          ((void *)0) 
# 356 "../include/pelib/map.c"
                               && pelib_pelib_pair_string_int_t_compare(e1->value, e2->value) == 0)
 {
  e1 = e1->next;
  e2 = e2->next;
 }
...
# 366 "../include/pelib/map.c"
 ...
 else return pelib_pelib_pair_string_int_t_compare(e1->value, e2->value);
}


pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_begin(map_string_int_t *map)
{
 return map->first;
}
...
pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_end(map_string_int_t *map)
{
 return 
...
pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_next(pelib_iterator_pelib_pair_string_int_t_t *i)
{
 return pelib_pelib_iterator_pelib_pair_string_int_t_next(i);
}

pelib_pair_string_int_t
pelib_map_string_int_read(pelib_iterator_pelib_pair_string_int_t_t *i)
{
 return pelib_pelib_iterator_pelib_pair_string_int_t_read(i);
}

pelib_iterator_pelib_pair_string_int_t_t*
pelib_map_string_int_find(map_string_int_t *map, string key)
{
 map_pelib_iterator_pelib_pair_string_int_t_t *i;
 for(i = pelib_map_string_int_begin(map); i != pelib_map_string_int_end(map); i = pelib_map_string_int_next(i))
 {
  string elem_key = pelib_map_string_int_read(i).key;
  if(pelib_string_compare(key, elem_key) == 0)
  {
   return i;
  }
 }
...
size_t
pelib_map_string_int_size(map_string_int_t *map)
{
 size_t size = 0;
 pelib_iterator_pelib_pair_string_int_t_t *i;


 for(i = pelib_map_string_int_begin(map); i != pelib_map_string_int_end(map); i = pelib_map_string_int_next(i), size++);

 return size;
}
# 15 "string_integer.c" 2
