...
# 3 "malloc.c" 2
# 1 "../include/pelib/malloc.h" 1




# 4 "../include/pelib/malloc.h"
...
# 138 "malloc.c"
 ...
 if (b2->free_size > size)
 {
  ...
  b3->next = b2->next;
  b2->next = b3;
  b3->free_size = b2->free_size - size;
  b3->space = b2->space + size;
 }
...
pelib_mem_free(pelib_malloc_queue_t *spacep, void *ptr)
{
 ...
 j1 = (b1->free_size > 0 && b1 != spacep->tail);
 j2 = (b3->free_size > 0 || b3 == spacep->tail);
