...
# 50 "string.c"
int
pelib_string_alloc_buffer(string *str, size_t n)
{
...
int
pelib_string_set_buffer(string *str, void* buffer, size_t n)
{
 *str = buffer;
 return 1;
}
...
int
pelib_string_copy(string s1, string *s2)
{
 if(*s2 == 
# 67 "string.c" 3 4
          ((void *)0)
# 67 "string.c"
 ...
 {
  pelib_string_alloc_buffer(s2, (strlen(s1) + 1) * sizeof(char));
 }
 strcpy(*s2, s1);
 return 1;
}
...
int
pelib_string_destroy(string val)
{
...
char*
pelib_string_string_detail(string a, int level)
{
 return pelib_string_string(a);
}

FILE*
pelib_string_printf(FILE* stream, string a)
{
 fprintf(stream, "%s\n", a);
 return stream;
}
...
pelib_pelib_set_string_t_alloc_struct()
{
 pelib_set_string_t* set;

 set = malloc(sizeof(pelib_set_string_t));
...
int
pelib_pelib_set_string_t_init(pelib_set_string_t* set)
{
 set->first = 
...
static
int
pelib_pelib_set_string_insert_element(pelib_set_string_t *set, pelib_iterator_string_t *elem)
{
 pelib_iterator_string_t *current = set->first, *previous = 
...
# 104 "../include/pelib/set.c"
                       && pelib_string_compare(elem->value, current->value) > 0)
  {
   previous = current;
  ...
  if(current != 0 && pelib_string_compare(elem->value, current->value) == 0)
  {
   return 0;
  }
...
int
pelib_pelib_set_string_insert(pelib_set_string_t* set, string value)
{
 pelib_iterator_string_t *new = pelib_pelib_iterator_string_t_alloc();
 pelib_pelib_iterator_string_t_init(new);
 pelib_string_copy(value, &new->value);
 if(!pelib_pelib_set_string_insert_element(set, new))
 {
  pelib_pelib_iterator_string_t_free(new);
  return 0;
 }
 else
 {
...
pelib_pelib_set_string_t_copy(pelib_set_string_t src, pelib_set_string_t* dst)
{
 ...
 pelib_iterator_string_t *elem = src.last;
 while(elem != 
...
# 174 "../include/pelib/set.c"
 ...
 {
  pelib_iterator_string_t *cpy = pelib_pelib_iterator_string_t_alloc();
  pelib_string_copy(elem->value, &cpy->value);
  pelib_pelib_set_string_insert_element(dst, cpy);
  elem = elem->previous;
 }
...
char*
pelib_pelib_set_string_t_string(pelib_set_string_t set)
{
 char *str, *grow, *elem;
 size_t i;
 ...
 pelib_iterator_string_t *el = set.first;
 while(el != 
...
# 196 "../include/pelib/set.c"
 ...
 {
  elem = pelib_string_string(el->value);
...
char*
pelib_pelib_set_string_t_string_detail(pelib_set_string_t set, int level)
{
 if(level == 0)
 {
  return pelib_pelib_set_string_t_string(set);
 }
 else
 {
...
# 248 "../include/pelib/set.c"
  ...
  {
   elem = pelib_string_string_detail(el->value, level);
   grow = malloc((strlen(str) + 1) * sizeof(char));
   sprintf(grow, "%s", str);
...
FILE*
pelib_pelib_set_string_t_printf(FILE* stream, pelib_set_string_t set)
{
 char * str;
 str = pelib_pelib_set_string_t_string(set);
...
FILE*
pelib_pelib_set_string_t_printf_detail(FILE* stream, pelib_set_string_t set, int level)
{
 char * str;
 str = pelib_pelib_set_string_t_string_detail(set, level);
...
int
pelib_pelib_set_string_t_destroy(pelib_set_string_t set)
{
 pelib_iterator_string_t *elem = set.first;
 while(elem != 
...
# 310 "../include/pelib/set.c"
 ...
 {
  pelib_iterator_string_t *current = elem;
  elem = elem->next;
  pelib_pelib_iterator_string_t_destroy(*current);
  pelib_pelib_iterator_string_t_free(current);
 }
 return 1;
}

int
pelib_pelib_set_string_t_free_buffer(pelib_set_string_t* set)
{
 pelib_iterator_string_t *elem = set->first;
 while(elem != 
...
int
pelib_pelib_set_string_t_free_struct(pelib_set_string_t* set)
{
 free(set);
 return 1;
}
...
int
pelib_pelib_set_string_t_free(pelib_set_string_t* set)
{
 pelib_pelib_set_string_t_free_buffer(set);
 pelib_pelib_set_string_t_free_struct(set);
 return 1;
}

int
pelib_pelib_set_string_t_compare(pelib_set_string_t a1, pelib_set_string_t a2)
{
 pelib_iterator_string_t *e1 = a1.first;
 pelib_iterator_string_t *e2 = a2.first;
...
# 355 "../include/pelib/set.c" 3 4
                          ((void *)0) 
# 355 "../include/pelib/set.c"
                               && pelib_pelib_iterator_string_t_compare(*e1, *e2) == 0)
 {
  e1 = e1->next;
  e2 = e2->next;
 }
...
# 365 "../include/pelib/set.c"
 ...
 else return pelib_pelib_iterator_string_t_compare(*e1, *e2);
}
# 124 "string.c" 2
...
pelib_pelib_pair_string_string_t_alloc_struct()
{
 pelib_pair_string_string_t* pelib_pair;

 pelib_pair = malloc(sizeof(pelib_pair_string_string_t));
...
int
pelib_pelib_pair_string_string_t_init(pelib_pair_string_string_t* pelib_pair)
{
 int a = pelib_string_init(&pelib_pair->key);
 return a && pelib_string_init(&pelib_pair->value);
}
...
pelib_pelib_pair_string_string_t_copy(pelib_pair_string_string_t src, pelib_pair_string_string_t* dst)
{
 ...
 return a && pelib_string_copy(src.value, &dst->value);
}



char*
pelib_pelib_pair_string_string_t_string(pelib_pair_string_string_t pelib_pair)
{
 char *key = pelib_string_string(pelib_pair.key);
 char *value = pelib_string_string(pelib_pair.value);
...
char*
pelib_pelib_pair_string_string_t_string_detail(pelib_pair_string_string_t pelib_pair, int level)
{
 if(level == 0)
 {
  return pelib_pelib_pair_string_string_t_string(pelib_pair);
 }
 else
 {
  char *key = pelib_string_string(pelib_pair.key);
...
FILE*
pelib_pelib_pair_string_string_t_printf(FILE* stream, pelib_pair_string_string_t pelib_pair)
{
 char * str;
 str = pelib_pelib_pair_string_string_t_string(pelib_pair);
...
FILE*
pelib_pelib_pair_string_string_t_printf_detail(FILE* stream, pelib_pair_string_string_t pelib_pair, int level)
{
 char * str;
 str = pelib_pelib_pair_string_string_t_string_detail(pelib_pair, level);
...
int
pelib_pelib_pair_string_string_t_free(pelib_pair_string_string_t* pelib_pair)
{
 return pelib_pelib_pair_string_string_t_free_struct(pelib_pair);
}

int
pelib_pelib_pair_string_string_t_free_struct(pelib_pair_string_string_t* pelib_pair)
{
 pelib_string_destroy(pelib_pair->key);
 pelib_string_destroy(pelib_pair->value);
 free(pelib_pair);
 return 0;
}

int
pelib_pelib_pair_string_string_t_compare(pelib_pair_string_string_t a1, pelib_pair_string_string_t a2)
{
 int a = pelib_string_compare(a1.key, a2.key);
 int b = pelib_string_compare(a1.value, a2.value);
 return a == 0 ? b : a;
}

int
pelib_pelib_pair_string_string_t_destroy(pelib_pair_string_string_t set)
{
 pelib_string_destroy(set.key);
 pelib_string_destroy(set.value);
 return 1;
}
# 129 "string.c" 2
...
pelib_pelib_iterator_string_t_alloc_struct()
{
 pelib_iterator_string_t* pelib_iterator;

 pelib_iterator = malloc(sizeof(pelib_iterator_string_t));
...
int
pelib_pelib_iterator_string_t_init(pelib_iterator_string_t* pelib_iterator)
{
...
# 59 "../include/pelib/iterator.c"
                           ;
 return pelib_string_init(&pelib_iterator->value);
}
 ...
 *dst = src;
 return pelib_string_copy(src.value, &dst->value);
}



char*
pelib_pelib_iterator_string_t_string(pelib_iterator_string_t pelib_iterator)
{
 char *value = pelib_string_string(pelib_iterator.value);
...
char*
pelib_pelib_iterator_string_t_string_detail(pelib_iterator_string_t pelib_iterator, int level)
{
 if(level == 0)
 {
  return pelib_pelib_iterator_string_t_string(pelib_iterator);
 }
 else
 {
  char *value = pelib_string_string_detail(pelib_iterator.value, level);
  char *elem = malloc((strlen(value) + 3) * sizeof(char*));
  strcpy(&elem[1], value);
  elem[0] = '{';
  elem[strlen(value)] = '}';
...
FILE*
pelib_pelib_iterator_string_t_printf(FILE* stream, pelib_iterator_string_t pelib_iterator)
{
 char * str;
 str = pelib_pelib_iterator_string_t_string(pelib_iterator);
...
FILE*
pelib_pelib_iterator_string_t_printf_detail(FILE* stream, pelib_iterator_string_t pelib_iterator, int level)
{
 char * str;
 str = pelib_pelib_iterator_string_t_string_detail(pelib_iterator, level);
...
int
pelib_pelib_iterator_string_t_destroy(pelib_iterator_string_t pelib_iterator)
{
 pelib_string_destroy(pelib_iterator.value);
 return 1;
}

int
pelib_pelib_iterator_string_t_free(pelib_iterator_string_t* pelib_iterator)
{
 return pelib_pelib_iterator_string_t_free_struct(pelib_iterator);
}

int
pelib_pelib_iterator_string_t_free_struct(pelib_iterator_string_t* pelib_iterator)
{
 free(pelib_iterator);
 return 0;
}
...
int
pelib_pelib_iterator_string_t_compare(pelib_iterator_string_t a1, pelib_iterator_string_t a2)
{
 return pelib_string_compare(a1.value, a2.value);
}

pelib_iterator_string_t*
pelib_pelib_iterator_string_next(pelib_iterator_string_t *el)
{
 if(el != 
...
string
pelib_pelib_iterator_string_read(pelib_iterator_string_t *el)
{
 return el->value;
}
...
pelib_pelib_iterator_string_distance(pelib_iterator_string_t *start, pelib_iterator_string_t *stop)
{
 ...
 pelib_iterator_string_t *i = start;

 while(pelib_pelib_iterator_string_t_compare(*i, *stop) != 0)
 {
  i = pelib_pelib_iterator_string_next(start);
  distance++;
 }
...
pelib_pelib_iterator_pelib_pair_string_string_t_t_alloc_struct()
{
 pelib_iterator_pelib_pair_string_string_t_t* pelib_iterator;

 pelib_iterator = malloc(sizeof(pelib_iterator_pelib_pair_string_string_t_t));
...
int
pelib_pelib_iterator_pelib_pair_string_string_t_t_init(pelib_iterator_pelib_pair_string_string_t_t* pelib_iterator)
{
 pelib_iterator->previous = 
# 58 "../include/pelib/iterator.c" 3 4
                           ((void *)0)
...
# 59 "../include/pelib/iterator.c"
                           ;
 return pelib_pelib_pair_string_string_t_init(&pelib_iterator->value);
}
 ...
 *dst = src;
 return pelib_pelib_pair_string_string_t_copy(src.value, &dst->value);
}



char*
pelib_pelib_iterator_pelib_pair_string_string_t_t_string(pelib_iterator_pelib_pair_string_string_t_t pelib_iterator)
{
 char *value = pelib_pelib_pair_string_string_t_string(pelib_iterator.value);
 char *elem = malloc((strlen(value) + 3) * sizeof(char*));
 strcpy(&elem[1], value);
 elem[0] = '{';
 elem[strlen(value)] = '}';
...
char*
pelib_pelib_iterator_pelib_pair_string_string_t_t_string_detail(pelib_iterator_pelib_pair_string_string_t_t pelib_iterator, int level)
{
 if(level == 0)
 {
  return pelib_pelib_iterator_pelib_pair_string_string_t_t_string(pelib_iterator);
 }
 else
 {
  char *value = pelib_pelib_pair_string_string_t_string_detail(pelib_iterator.value, level);
  char *elem = malloc((strlen(value) + 3) * sizeof(char*));
  strcpy(&elem[1], value);
  elem[0] = '{';
  elem[strlen(value)] = '}';
...
FILE*
pelib_pelib_iterator_pelib_pair_string_string_t_t_printf(FILE* stream, pelib_iterator_pelib_pair_string_string_t_t pelib_iterator)
{
 char * str;
 str = pelib_pelib_iterator_pelib_pair_string_string_t_t_string(pelib_iterator);
...
FILE*
pelib_pelib_iterator_pelib_pair_string_string_t_t_printf_detail(FILE* stream, pelib_iterator_pelib_pair_string_string_t_t pelib_iterator, int level)
{
 char * str;
 str = pelib_pelib_iterator_pelib_pair_string_string_t_t_string_detail(pelib_iterator, level);
...
int
pelib_pelib_iterator_pelib_pair_string_string_t_t_destroy(pelib_iterator_pelib_pair_string_string_t_t pelib_iterator)
{
 pelib_pelib_pair_string_string_t_destroy(pelib_iterator.value);
 return 1;
}

int
pelib_pelib_iterator_pelib_pair_string_string_t_t_free(pelib_iterator_pelib_pair_string_string_t_t* pelib_iterator)
{
 return pelib_pelib_iterator_pelib_pair_string_string_t_t_free_struct(pelib_iterator);
}

int
pelib_pelib_iterator_pelib_pair_string_string_t_t_free_struct(pelib_iterator_pelib_pair_string_string_t_t* pelib_iterator)
{
 free(pelib_iterator);
 return 0;
}
...
int
pelib_pelib_iterator_pelib_pair_string_string_t_t_compare(pelib_iterator_pelib_pair_string_string_t_t a1, pelib_iterator_pelib_pair_string_string_t_t a2)
{
 return pelib_pelib_pair_string_string_t_compare(a1.value, a2.value);
}

pelib_iterator_pelib_pair_string_string_t_t*
pelib_pelib_iterator_pelib_pair_string_string_t_next(pelib_iterator_pelib_pair_string_string_t_t *el)
{
 if(el != 
# 162 "../include/pelib/iterator.c" 3 4
         ((void *)0)
...
pelib_pair_string_string_t
pelib_pelib_iterator_pelib_pair_string_string_t_read(pelib_iterator_pelib_pair_string_string_t_t *el)
{
 return el->value;
}
...
pelib_pelib_iterator_pelib_pair_string_string_t_distance(pelib_iterator_pelib_pair_string_string_t_t *start, pelib_iterator_pelib_pair_string_string_t_t *stop)
{
 ...
 pelib_iterator_pelib_pair_string_string_t_t *i = start;

 while(pelib_pelib_iterator_pelib_pair_string_string_t_t_compare(*i, *stop) != 0)
 {
  i = pelib_pelib_iterator_pelib_pair_string_string_t_next(start);
  distance++;
 }
...
pelib_map_string_string_t_alloc_struct()
{
 map_string_string_t* map;

 map = malloc(sizeof(map_string_string_t));
...
int
pelib_map_string_string_t_init(map_string_string_t* map)
{
 map->first = 
...
static
int
pelib_map_string_string_insert_element(map_string_string_t *map, pelib_iterator_pelib_pair_string_string_t_t *elem)
{
 pelib_iterator_pelib_pair_string_string_t_t *current = map->first, *previous = 
...
int
pelib_map_string_string_insert(map_string_string_t* map, pelib_pair_string_string_t value)
{
 pelib_iterator_pelib_pair_string_string_t_t *new = pelib_pelib_iterator_pelib_pair_string_string_t_t_alloc();
 pelib_pelib_iterator_pelib_pair_string_string_t_t_init(new);
 pelib_pelib_pair_string_string_t_copy(value, &new->value);
 if(!pelib_map_string_string_insert_element(map, new))
 {
  pelib_pelib_iterator_pelib_pair_string_string_t_t_free(new);
  return 0;
 }
 else
 {
...
pelib_map_string_string_t_copy(map_string_string_t src, map_string_string_t* dst)
{
 ...
 pelib_iterator_pelib_pair_string_string_t_t *elem = src.last;
 while(elem != 
...
# 177 "../include/pelib/map.c"
 ...
 {
  pelib_iterator_pelib_pair_string_string_t_t *cpy = pelib_pelib_iterator_pelib_pair_string_string_t_t_alloc();
  pelib_pelib_pair_string_string_t_copy(elem->value, &cpy->value);
  pelib_map_string_string_insert_element(dst, cpy);
  elem = elem->previous;
 }
...
char*
pelib_map_string_string_t_string(map_string_string_t map)
{
 char *str, *grow, *elem;
 size_t i;
 str = malloc(3 * sizeof(char));
 ...
 pelib_iterator_pelib_pair_string_string_t_t *el = map.first;
 while(el != 
...
# 199 "../include/pelib/map.c"
 ...
 {
  elem = pelib_pelib_pair_string_string_t_string(el->value);
  grow = malloc((strlen(str) + 1) * sizeof(char));
  sprintf(grow, "%s", str);
...
char*
pelib_map_string_string_t_string_detail(map_string_string_t map, int level)
{
 if(level == 0)
 {
  return pelib_map_string_string_t_string(map);
 }
 else
 {
...
# 251 "../include/pelib/map.c"
  ...
  {
   elem = pelib_pelib_pair_string_string_t_string_detail(el->value, level);
   grow = malloc((strlen(str) + 1) * sizeof(char));
   sprintf(grow, "%s", str);
...
FILE*
pelib_map_string_string_t_printf(FILE* stream, map_string_string_t map)
{
 char * str;
 str = pelib_map_string_string_t_string(map);
...
FILE*
pelib_map_string_string_t_printf_detail(FILE* stream, map_string_string_t map, int level)
{
 char * str;
 str = pelib_map_string_string_t_string_detail(map, level);
...
int
pelib_map_string_string_t_destroy(map_string_string_t map)
{
 pelib_iterator_pelib_pair_string_string_t_t *elem = map.first;
 while(elem != 
...
# 313 "../include/pelib/map.c"
 ...
 {
  pelib_iterator_pelib_pair_string_string_t_t *current = elem;
  elem = elem->next;
  pelib_pelib_iterator_pelib_pair_string_string_t_t_destroy(*current);
 }
 return 1;
}

int
pelib_map_string_string_t_free_buffer(map_string_string_t* map)
{
 pelib_iterator_pelib_pair_string_string_t_t *elem = map->first;
 while(elem != 
...
# 326 "../include/pelib/map.c"
                  )
 {
  pelib_iterator_pelib_pair_string_string_t_t *current = elem;
  elem = elem->next;
  pelib_pelib_iterator_pelib_pair_string_string_t_t_free(current);
 }
 return 1;
}

int
pelib_map_string_string_t_free_struct(map_string_string_t* map)
{
 free(map);
 return 1;
}
...
int
pelib_map_string_string_t_free(map_string_string_t* map)
{
 pelib_map_string_string_t_free_buffer(map);
 pelib_map_string_string_t_free_struct(map);
 return 1;
}

int
pelib_map_string_string_t_compare(map_string_string_t a1, map_string_string_t a2)
{
 pelib_iterator_pelib_pair_string_string_t_t *e1 = a1.first;
 pelib_iterator_pelib_pair_string_string_t_t *e2 = a2.first;
...
# 356 "../include/pelib/map.c" 3 4
                          ((void *)0) 
# 356 "../include/pelib/map.c"
                               && pelib_pelib_pair_string_string_t_compare(e1->value, e2->value) == 0)
 {
  e1 = e1->next;
  e2 = e2->next;
 }
...
# 366 "../include/pelib/map.c"
 ...
 else return pelib_pelib_pair_string_string_t_compare(e1->value, e2->value);
}


pelib_iterator_pelib_pair_string_string_t_t*
pelib_map_string_string_begin(map_string_string_t *map)
{
 return map->first;
}
...
pelib_iterator_pelib_pair_string_string_t_t*
pelib_map_string_string_end(map_string_string_t *map)
{
 return 
...
pelib_iterator_pelib_pair_string_string_t_t*
pelib_map_string_string_next(pelib_iterator_pelib_pair_string_string_t_t *i)
{
 return pelib_pelib_iterator_pelib_pair_string_string_t_next(i);
}

pelib_pair_string_string_t
pelib_map_string_string_read(pelib_iterator_pelib_pair_string_string_t_t *i)
{
 return pelib_pelib_iterator_pelib_pair_string_string_t_read(i);
}

pelib_iterator_pelib_pair_string_string_t_t*
pelib_map_string_string_find(map_string_string_t *map, string key)
{
 map_pelib_iterator_pelib_pair_string_string_t_t *i;
 for(i = pelib_map_string_string_begin(map); i != pelib_map_string_string_end(map); i = pelib_map_string_string_next(i))
 {
  string elem_key = pelib_map_string_string_read(i).key;
...
size_t
pelib_map_string_string_size(map_string_string_t *map)
{
 size_t size = 0;
 pelib_iterator_pelib_pair_string_string_t_t *i;


 for(i = pelib_map_string_string_begin(map); i != pelib_map_string_string_end(map); i = pelib_map_string_string_next(i), size++);
...
pelib_pelib_set_pelib_pair_string_string_t_t_alloc_struct()
{
 pelib_set_pelib_pair_string_string_t_t* set;

 set = malloc(sizeof(pelib_set_pelib_pair_string_string_t_t));
...
int
pelib_pelib_set_pelib_pair_string_string_t_t_init(pelib_set_pelib_pair_string_string_t_t* set)
{
 set->first = 
# 83 "../include/pelib/set.c" 3 4
             ((void *)0)
...
static
int
pelib_pelib_set_pelib_pair_string_string_t_insert_element(pelib_set_pelib_pair_string_string_t_t *set, pelib_iterator_pelib_pair_string_string_t_t *elem)
{
 pelib_iterator_pelib_pair_string_string_t_t *current = set->first, *previous = 
# 95 "../include/pelib/set.c" 3 4
                                                           ((void *)0)
# 95 "../include/pelib/set.c"
                                                               ;
...
# 104 "../include/pelib/set.c" 3 4
                  ((void *)0) 
# 104 "../include/pelib/set.c"
                       && pelib_pelib_pair_string_string_t_compare(elem->value, current->value) > 0)
  {
   previous = current;
   current = current->next;
  }
  ...
  if(current != 0 && pelib_pelib_pair_string_string_t_compare(elem->value, current->value) == 0)
  {
   return 0;
  }
...
int
pelib_pelib_set_pelib_pair_string_string_t_insert(pelib_set_pelib_pair_string_string_t_t* set, pelib_pair_string_string_t value)
{
 pelib_iterator_pelib_pair_string_string_t_t *new = pelib_pelib_iterator_pelib_pair_string_string_t_t_alloc();
 pelib_pelib_iterator_pelib_pair_string_string_t_t_init(new);
 pelib_pelib_pair_string_string_t_copy(value, &new->value);
 if(!pelib_pelib_set_pelib_pair_string_string_t_insert_element(set, new))
 {
  pelib_pelib_iterator_pelib_pair_string_string_t_t_free(new);
  return 0;
 }
...
# 174 "../include/pelib/set.c"
                  )
 {
  pelib_iterator_pelib_pair_string_string_t_t *cpy = pelib_pelib_iterator_pelib_pair_string_string_t_t_alloc();
  pelib_pelib_pair_string_string_t_copy(elem->value, &cpy->value);
  pelib_pelib_set_pelib_pair_string_string_t_insert_element(dst, cpy);
  elem = elem->previous;
 }
...
char*
pelib_pelib_set_pelib_pair_string_string_t_t_string(pelib_set_pelib_pair_string_string_t_t set)
{
 char *str, *grow, *elem;
 size_t i;
 str = malloc(3 * sizeof(char));
 ...
 pelib_iterator_pelib_pair_string_string_t_t *el = set.first;
 while(el != 
# 196 "../include/pelib/set.c" 3 4
            ((void *)0) 
# 196 "../include/pelib/set.c"
...
char*
pelib_pelib_set_pelib_pair_string_string_t_t_string_detail(pelib_set_pelib_pair_string_string_t_t set, int level)
{
 if(level == 0)
 {
  return pelib_pelib_set_pelib_pair_string_string_t_t_string(set);
 }
 else
 {
...
FILE*
pelib_pelib_set_pelib_pair_string_string_t_t_printf(FILE* stream, pelib_set_pelib_pair_string_string_t_t set)
{
 char * str;
 str = pelib_pelib_set_pelib_pair_string_string_t_t_string(set);
...
FILE*
pelib_pelib_set_pelib_pair_string_string_t_t_printf_detail(FILE* stream, pelib_set_pelib_pair_string_string_t_t set, int level)
{
 char * str;
 str = pelib_pelib_set_pelib_pair_string_string_t_t_string_detail(set, level);
...
int
pelib_pelib_set_pelib_pair_string_string_t_t_destroy(pelib_set_pelib_pair_string_string_t_t set)
{
 pelib_iterator_pelib_pair_string_string_t_t *elem = set.first;
 while(elem != 
# 310 "../include/pelib/set.c" 3 4
              ((void *)0)
# 310 "../include/pelib/set.c"
...
int
pelib_pelib_set_pelib_pair_string_string_t_t_free_buffer(pelib_set_pelib_pair_string_string_t_t* set)
{
 pelib_iterator_pelib_pair_string_string_t_t *elem = set->first;
 while(elem != 
# 324 "../include/pelib/set.c" 3 4
...
int
pelib_pelib_set_pelib_pair_string_string_t_t_free_struct(pelib_set_pelib_pair_string_string_t_t* set)
{
 free(set);
 return 1;
}
...
int
pelib_pelib_set_pelib_pair_string_string_t_t_free(pelib_set_pelib_pair_string_string_t_t* set)
{
 pelib_pelib_set_pelib_pair_string_string_t_t_free_buffer(set);
 pelib_pelib_set_pelib_pair_string_string_t_t_free_struct(set);
 return 1;
}

int
pelib_pelib_set_pelib_pair_string_string_t_t_compare(pelib_set_pelib_pair_string_string_t_t a1, pelib_set_pelib_pair_string_string_t_t a2)
{
 pelib_iterator_pelib_pair_string_string_t_t *e1 = a1.first;
 pelib_iterator_pelib_pair_string_string_t_t *e2 = a2.first;
...
# 355 "../include/pelib/set.c" 3 4
                          ((void *)0) 
# 355 "../include/pelib/set.c"
                               && pelib_pelib_iterator_pelib_pair_string_string_t_t_compare(*e1, *e2) == 0)
 {
  e1 = e1->next;
  e2 = e2->next;
 }
...
# 365 "../include/pelib/set.c"
 ...
 else return pelib_pelib_iterator_pelib_pair_string_string_t_t_compare(*e1, *e2);
}
# 144 "string.c" 2
