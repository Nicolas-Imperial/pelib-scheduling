# 1 "argument_parsing.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "argument_parsing.cpp"
# 21 "argument_parsing.cpp"
...
# 103 "/usr/include/c++/7/type_traits" 3
  ...
  template<typename _Pp>
    ...
    { };
# 195 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp>
  ...
  template<>
    ...
    : public true_type { };
# 327 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp>
    struct is_integral
  ...
  template<>
    ...
    : public true_type { };
# 355 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp>
  ...
  template<typename _Tp>
    ...
    { };
# 727 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp>
    struct is_abstract
  ...
  template<typename _Tp>
    ...
    { };
# 939 "/usr/include/c++/7/type_traits" 3
...
# 1630 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp>
    struct remove_reference
    { typedef _Tp type; };
  ...
  template<typename _Tp>
    ...
    { };
# 1687 "/usr/include/c++/7/type_traits" 3
  ...
  template<>
    ...
    { };
# 1774 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp,
...
# 1863 "/usr/include/c++/7/type_traits" 3
  template<>
  ...
  template<>
    ...
    { };
# 1893 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp,
    bool _IsInt = is_integral<_Tp>::value,
    bool _IsEnum = is_enum<_Tp>::value>
...
# 1943 "/usr/include/c++/7/type_traits" 3
  template<typename _Tp>
  ...
  template<typename _Tp>
    ...
    { typedef typename remove_all_extents<_Tp>::type type; };
# 1980 "/usr/include/c++/7/type_traits" 3
  ...
  template<typename _Tp>
    ...
    { };
# 2019 "/usr/include/c++/7/type_traits" 3
...
# 2039 "/usr/include/c++/7/type_traits" 3
...
# 2078 "/usr/include/c++/7/type_traits" 3
 ...
 _Functor, _ArgTypes...
  ...
  template<typename _Functor, typename... _ArgTypes>
    ...
    { };
# 2498 "/usr/include/c++/7/type_traits" 3
  template<typename...> using __void_t = void;
# 2507 "/usr/include/c++/7/type_traits" 3
...
# 2551 "/usr/include/c++/7/type_traits" 3
  template <typename _Tp>
  ...
  template<typename _Tp>
    ...
    { };
# 2756 "/usr/include/c++/7/type_traits" 3
...
# 3112 "/usr/include/c++/7/type_traits" 3
...
# 422 "/usr/include/c++/7/bits/stl_iterator.h" 3
  template<typename _Iterator>
    auto
...
namespace std __attribute__ ((__visibility__ ("default")))
{
  ...
  template<typename _Tp, size_t _Nm>
    ...
    { return __arr + _Nm; }
# 319 "/usr/include/c++/7/bits/range_access.h" 3
...
# 6690 "/usr/include/c++/7/bits/basic_string.h" 3
}
...
# 26 "argument_parsing.cpp" 2

# 1 "../include/pelib/argument_parsing.hpp" 1
# 24 "../include/pelib/argument_parsing.hpp"
...
{
 pelib_argument_stream->library = 
# 40 "argument_parsing.cpp" 3 4
                                 __null
# 40 "argument_parsing.cpp"
                                     ;
 pelib_argument_stream->argv = (char**)malloc(sizeof(char*) * 1);
 pelib_argument_stream->argv[0] = 
# 42 "argument_parsing.cpp" 3 4
                                 __null
# 42 "argument_parsing.cpp"
                                     ;
 pelib_argument_stream->argc = 0;
 pelib_argument_stream->filename = 
# 44 "argument_parsing.cpp" 3 4
                                  __null
# 44 "argument_parsing.cpp"
                                      ;
 pelib_argument_stream->name = 
# 45 "argument_parsing.cpp" 3 4
                              __null
# 45 "argument_parsing.cpp"
                                  ;
...
pelib_argument_stream_destroy(const pelib_argument_stream_t pelib_argument_stream)
{
 ...
 if(pelib_argument_stream.library != 
# 54 "argument_parsing.cpp" 3 4
                                    __null
# 54 "argument_parsing.cpp"
                                        )
 {
  free(pelib_argument_stream.library);
 }

 if(pelib_argument_stream.filename != 
# 59 "argument_parsing.cpp" 3 4
                                     __null
# 59 "argument_parsing.cpp"
                                         )
 {
  free(pelib_argument_stream.filename);
 }

 if(pelib_argument_stream.name != 
# 64 "argument_parsing.cpp" 3 4
                                 __null
# 64 "argument_parsing.cpp"
                                     )
 {
...
is_reserved(char* str)
{
 ...
 if(str == 
# 74 "argument_parsing.cpp" 3 4
          __null 
# 74 "argument_parsing.cpp"
               || string(str).compare("-") == 0)
 {
  return true;
 }
...
add_argument(pelib_argument_stream *stream, char *argv)
{
   ...
   stream->argc++;
   stream->argv[stream->argc] = 
# 95 "argument_parsing.cpp" 3 4
                               __null
# 95 "argument_parsing.cpp"
                                   ;
}
...
pelib_argument_stream_parse(char **argv, pelib_argument_stream_t* stream)
{
 ...
 while((void*)argv[0] != 
# 102 "argument_parsing.cpp" 3 4
                        __null 
# 102 "argument_parsing.cpp"
                             && string(argv[0]).compare("--") != 0)
 {
  ...
  if(string(*argv).compare("--args") == 0)
  {
   ...
   while(*argv != 
# 231 "argument_parsing.cpp" 3 4
                 __null
# 231 "argument_parsing.cpp"
                     )
   {
     if(string(*argv).compare("--args") == 0)
    {
   ...
   if(*argv != 
# 253 "argument_parsing.cpp" 3 4
              __null
# 253 "argument_parsing.cpp"
                  )
   {
    if(string(*argv).compare("--") == 0)
    {
