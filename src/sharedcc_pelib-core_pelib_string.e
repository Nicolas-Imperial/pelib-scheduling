...
# 1 "../include/pelib/pelib_string.h" 1
# 27 "../include/pelib/pelib_string.h"
...
# 59 "../include/pelib/structure.h"
pelib_string *
pelib_pelib_string_alloc_struct();
...
int
pelib_pelib_string_alloc_buffer(pelib_string* obj, size_t n);
...
int
pelib_pelib_string_set_buffer(pelib_string* obj, void* buffer, size_t n);



pelib_string *
pelib_pelib_string_alloc();
...
pelib_string *
pelib_pelib_string_alloc_collection(size_t n);
...
pelib_string *
pelib_pelib_string_alloc_from(void* buffer, size_t n);
...
int
pelib_pelib_string_init(pelib_string *obj);
...
int
pelib_pelib_string_copy(pelib_string src, pelib_string* dst);
...
int
pelib_pelib_string_free_struct(pelib_string *obj);
...
int
pelib_pelib_string_free_buffer(pelib_string *);




int
pelib_pelib_string_free(pelib_string *);




int
pelib_pelib_string_destroy(pelib_string);




int
pelib_pelib_string_compare(pelib_string a, pelib_string b);
...
FILE*
pelib_pelib_string_printf(FILE* str, pelib_string obj);
...
FILE*
pelib_pelib_string_printf_detail(FILE* str, pelib_string obj, int lvl);
...
size_t
pelib_pelib_string_fwrite(pelib_string obj, FILE* str);
...
size_t
pelib_pelib_string_fread(pelib_string* obj, FILE* str);


char*
pelib_pelib_string_string(pelib_string);
...
char*
pelib_pelib_string_string_detail(pelib_string, int);
# 31 "../include/pelib/pelib_string.h" 2
...
int
pelib_pelib_string_copy(pelib_string s1, pelib_string *s2)
{
...
int
pelib_pelib_string_init(pelib_string *val)
{
 **val = '\0';
...
char*
pelib_pelib_string_string(pelib_string a)
{
 size_t size;
 char* str;
...
char*
pelib_pelib_string_string_detail(pelib_string a, int level)
{
 return pelib_pelib_string_string(a);
}

FILE*
pelib_pelib_string_printf(FILE* stream, pelib_string a)
{
 char* str = pelib_pelib_string_string(a);
